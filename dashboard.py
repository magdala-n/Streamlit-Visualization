...
LOGO_URL_LARGE="https://github.com/magdala-n/Streamlit-Visualization/blob/main/logo_bangkit.png"
LOGO_URL_SMALL="https://github.com/magdala-n/Streamlit-Visualization/blob/main/logo_bangkit_small.png"
...
<br><br>           
  ...
  3. **What is the distribution of bike sharing usage across the week?**
...
# For question 3
    ...
    st.subheader('What is the distribution of bike sharing usage across the week?')
...
<br><br>
    <strong>What is the distribution of bike sharing usage across the week?</strong>
<br>
